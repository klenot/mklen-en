!(function () {
  ...
  ;((n.n = function (t) {
    ...
    (function () {
      ...
      function W(t, e, n) {
        ...
        return (
          e.forEach(function (e, o) {
            void 0 === r[o] ? (r[o] = n.cloneUnlessOtherwiseSpecified(e, n))
            : n.isMergeableObject(e) ? (r[o] = Y(t[o], e, n))
        ...
        ;((n.arrayMerge = (function (t) {
          ...
          return (
            "combine" === t.arrayMerge ?
              (e = W)
            : U(t.arrayMerge) && (e = t.arrayMerge),
            e
          )
        })(n)),
          (n.isMergeableObject = n.isMergeableObject || H),
          (n.cloneUnlessOtherwiseSpecified = q))
        var r = Array.isArray(e)
        return (
          r === Array.isArray(t) ?
            r ? n.arrayMerge(t, e, n)
            : G(t, e, n)
          : q(e, n)
        )
      }
      ...
      function tt(t) {
        return (
          t < 1024 ? "".concat(t, " Bytes")
          : t < 1048576 ? "".concat((t / 1024).toFixed(1), " KB")
          : t < 1073741824 ? "".concat((t / 1048576).toFixed(1), " MB")
      ...
      var ot = function (t, e) {
        ...
        var r = e || n
        return (
          t.sizes && t.sizes[r] && t.sizes[r].url ? t.sizes[r].url
          : r !== n && t.sizes && t.sizes[n] && t.sizes[n].url ? t.sizes[n].url
          : t.url || ""
        )
      }
      function it() {
      ...
      var wt = function (t, e, n, r) {
        ...
        jt = function (t, e, n) {
          ...
          ;(Object.defineProperty(o, "name", At),
        ...
        return (function (t, e) {
          ...
          for (r = 0; r < d; r++)
            if ("string" == typeof t[r]) p += t[r]
              ...
              if (
                (Dt.not_type.test(i.type) &&
                  Dt.not_primitive.test(i.type) &&
                  n instanceof Function &&
                  (n = n()),
                Dt.numeric_arg.test(i.type) && "number" != typeof n && isNaN(n))
              )
                throw new TypeError(
                  Zt("[sprintf] expecting number but found %T", n),
                )
              ...
              Dt.json.test(i.type) ?
                (p += n)
              : (!Dt.number.test(i.type) || (l && !i.sign) ?
                  (s = "")
                : ((s = l ? "+" : "-"),
                  (n = n.toString().replace(Dt.sign, ""))),
                (c =
                  i.pad_char ?
                    "0" === i.pad_char ?
                      "0"
          ...
          (function (t) {
            ...
            for (; n; ) {
              if (null !== (e = Dt.text.exec(n))) r.push(e[0])
                ...
                if (null === (e = Dt.placeholder.exec(n)))
                ...
                if (e[2]) {
                  ...
                  for (i.push(c[1]); "" !== (a = a.substring(c[0].length)); )
                    if (null !== (c = Dt.key_access.exec(a))) i.push(c[1])
                      ...
                      if (null === (c = Dt.index_access.exec(a)))
                        throw new SyntaxError(
                          "[sprintf] failed to parse named argument key",
                        )
                      i.push(c[1])
      ...
      var Yt = n(192),
        ...
        re = !!window.chrome,
        oe = "undefined" != typeof InstallTrigger,
        ...
        se =
          ...
          (!re && !le && "undefined" !== window.webkitAudioContext),
      ...
      function pe() {
        ...
        ;(t.android ? e.add("device-android") : t.ios && e.add("device-ios"),
          t.edge ? e.add("browser-edge")
          : t.chrome ? e.add("browser-chrome")
          : t.firefox ? e.add("browser-firefox")
          : t.ie ? e.add("browser-ie")
          : t.opera ? e.add("browser-opera")
      ...
      var Ze = function (t) {
          ...
          n.instances &&
            t &&
            je("[data-simplebar]", !0, t, !0).forEach(function (t) {
              var e
        ...
        We = function (t) {
          ;(Ue[t].up &&
            (window.cancelAnimationFrame(Ue[t].up), (Ue[t].up = null)),
            Ue[t].down &&
              (window.cancelAnimationFrame(Ue[t].down), (Ue[t].down = null)))
        },
        Be = function (t, e) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2] ?
          ...
          var c = function (u) {
            ...
            ;((t.style.maxHeight = "".concat(s, "px")),
              ...
              : ((Ue[e].down = null), (t.style.maxHeight = "none"), r && r()))
          }
          setTimeout(function () {
            Ue[e].down = window.requestAnimationFrame(c)
          }, He)
        ...
        Je = function (t, e) {
          ...
          var a = function (c) {
            ...
            ;((t.style.maxHeight = "".concat(l, "px")),
              ...
              : ((Ue[e].up = null), (t.style.maxHeight = "0"), r && r()))
          }
          setTimeout(function () {
            Ue[e].up = window.requestAnimationFrame(a)
          }, He)
      ...
      if ("undefined" != typeof Element && !Element.prototype.matches) {
        ...
        on.matches =
          on.matchesSelector ||
          on.mozMatchesSelector ||
          on.msMatchesSelector ||
          on.oMatchesSelector ||
          on.webkitMatchesSelector
      }
      ...
      var un = function (t, e, n, r) {
        ...
        return (
          "function" == typeof t.addEventListener ? an.apply(null, arguments)
          : "function" == typeof n ?
            an.bind(null, document).apply(null, arguments)
      ...
      var ln = (function () {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ...
                        (n = window.gform.instances.filters),
                        (r = Et(
                          {
                            data: {},
                            event: "",
        ...
        dn = function (t) {
          ...
          if (void 0 !== r[t])
            for (var o = r[t], i = o.length - 1; i >= 0; i--)
              (null !== n && n !== o[i].tag) ||
                (null !== e && parseInt(o[i].priority) !== parseInt(e)) ||
                o.splice(i, 1)
        }
      function pn(t) {
